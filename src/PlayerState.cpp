...
PlayerState::PlayerState(): CharacterController(eCharacterControllerType_Human)
{
...
void PlayerState::OnControllerStart()
{
...
void PlayerState::OnControllerStop()
{
    mFollowCameraController.SetFollowTarget(nullptr);
}

void PlayerState::SetCurrentCameraMode(ePlayerCameraMode cameraMode)
{
...
ePlayerCameraMode PlayerState::GetCurrentCameraMode() const
{
...
void PlayerState::InputEvent(MouseButtonInputEvent& inputEvent)
{
    if (mCameraController)
    {
...
void PlayerState::InputEvent(MouseMovedInputEvent& inputEvent)
{
    if (mCameraController)
    {
        mCameraController->InputEvent(inputEvent);
...
void PlayerState::InputEvent(MouseScrollInputEvent& inputEvent)
{
    if (mCameraController)
    {
        mCameraController->InputEvent(inputEvent);
...
void PlayerState::InputEvent(KeyInputEvent& inputEvent)
{
    cxx_assert(mCharacter);
...
void PlayerState::InputEvent(GamepadInputEvent& inputEvent)
{
    cxx_assert(mCharacter);
...
void PlayerState::InputEventLost()
{
    if (mCameraController)
    {
...
void PlayerState::ProcessInputAction(eInputAction action, bool isActivated)
{    
    switch (action)
    {
...
void PlayerState::SwitchNextWeapon()
{
...
void PlayerState::SwitchPrevWeapon()
{
...
void PlayerState::EnterOrExitCar(bool alternative)
{
    if (mCharacter->IsCarPassenger())
    {
        mCharacter->LeaveCar();
...
void PlayerState::ProcessRepetitiveActions()
{
    if (!mUpdateInputs)
        return;
...
bool PlayerState::GetActionState(eInputAction action) const
{
...
void PlayerState::UpdateDistrictLocation()
{
...
void PlayerState::SetMouseAiming(bool isEnabled)
{
    mMouseAimingEnabled = isEnabled;
}

bool PlayerState::IsMouseAmingEnabled() const
{
    return mMouseAimingEnabled;
}

void PlayerState::UpdateMouseAiming()
{
...
void PlayerState::UpdateRespawnTimer()
{
...
void PlayerState::ShowLastDistrictLocation()
{
    mHUD.ShowDistrictNameMessage(mLastDistrictIndex);
}

void PlayerState::SetScreenViewArea(const Rect& screenViewArea)
{
